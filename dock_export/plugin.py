...
class DockExportPlugin:
    ...
    def _toggle_dock(self, checked: bool):
        if checked:
            if self._dock is None:
                self._dock = ExportDockWidget(self.iface,
    ...
    def _on_layer_tree_context_menu(self, point: QPoint):
        # No view / menu provider: nothing to do
    ...
    def _open_dock_export_for_layer(self, layer):
        if self._dock is None:
